...
return(
    ...
    <Icon
        ...
        style={{margin: 10}}
    />
        <Text style={styles.ButtonText} type="clear">{props.title}</Text>
    <Icon
        type='font-awesome'
        name='chevron-right'
        color='#517fa4'
...
function SplashScreen({ navigation, loading }) {
  ...
  return (
    <View style={styles.buttonContainer}>
        <ButtonStyled title={TranslateSplashScreen("login")} onPress={() => navigation.navigate('Login')} />
        <ButtonStyled title={TranslateSplashScreen("signIn")} onPress={() => navigation.navigate('SignIn')} />
    </View>
  );
}
